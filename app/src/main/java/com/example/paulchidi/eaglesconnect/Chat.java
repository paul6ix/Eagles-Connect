...
import com.example.paulchidi.eaglesconnect.custom.CustomActivity;
import com.example.paulchidi.eaglesconnect.fragments.ContactsFragment;
import com.example.paulchidi.eaglesconnect.model.Conversation;
...
public class Chat extends CustomActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buddy = getIntent().getStringExtra(ParseConstants.EXTRA_DATA);
    ...
    private void sendMessage() {
        ...
        final Conversation c = new Conversation(s, new Date(),
                ContactsFragment.mCurrentUser.getUsername());
        ...
        po.put("sender", ContactsFragment.mCurrentUser.getUsername());
    ...
    private void loadConversationList() {
        ...
        if (convList.size() == 0) {
            ...
            al.add(buddy);
            al.add(ContactsFragment.mCurrentUser.getUsername());
            ...
            q.whereEqualTo("receiver", ContactsFragment.mCurrentUser.getUsername());
        }
